...
public class EbiAnalyseVarietyNodeFactory extends EbiDefaultNodeFactory {
	...
	public EbiAnalyseVarietyNodeFactory() {
		super(COMMAND_METADATA, EbiAnalyseVarietyNodeFactory::addPorts, EbiAnalyseVarietyNodeFactory::configureModel);
	}
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiAnalyseVarietyNodeFactory::configure)
            .execute(EbiAnalyseVarietyNodeFactory::execute);
    }
    ...
    public static void configure(final DefaultModel.ConfigureInput input, final DefaultModel.ConfigureOutput output) 
        ...
        output.setOutSpec(0, TableUtil.createOutputSpec("Ebi analyse variety", "Ebi analyse variety", StringCell.TYPE));
    }
    ...
    public static void execute(final DefaultModel.ExecuteInput input, final DefaultModel.ExecuteOutput output) {
        try {
            ...
            throw new RuntimeException("Ebi command failed: Ebi analyse variety", ex);
        }
    }
}
