...
public class EbiAssociationAllTraceAttributesNodeFactory extends EbiDefaultNodeFactory {
	...
	public EbiAssociationAllTraceAttributesNodeFactory() {
		super(COMMAND_METADATA, EbiAssociationAllTraceAttributesNodeFactory::addPorts, EbiAssociationAllTraceAttributesNodeFactory::configureModel);
	}
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .parametersClass(EbiAssociationAllTraceAttributesNodeSettings.class)
            .configure(EbiAssociationAllTraceAttributesNodeFactory::configure)
            .execute(EbiAssociationAllTraceAttributesNodeFactory::execute);
    }
    ...
    public static void execute(final DefaultModel.ExecuteInput input, final DefaultModel.ExecuteOutput output) {
        try {
            ...
            final EbiAssociationAllTraceAttributesNodeSettings settings = input.getParameters();
