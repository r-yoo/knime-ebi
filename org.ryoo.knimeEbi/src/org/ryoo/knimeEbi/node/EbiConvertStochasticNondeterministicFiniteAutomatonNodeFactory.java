...
public class EbiConvertStochasticNondeterministicFiniteAutomatonNodeFactory extends EbiDefaultNodeFactory {
	...
	public EbiConvertStochasticNondeterministicFiniteAutomatonNodeFactory() {
		super(COMMAND_METADATA, EbiConvertStochasticNondeterministicFiniteAutomatonNodeFactory::addPorts, EbiConvertStochasticNondeterministicFiniteAutomatonNodeFactory::configureModel);
	}
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiConvertStochasticNondeterministicFiniteAutomatonNodeFactory::configure)
            .execute(EbiConvertStochasticNondeterministicFiniteAutomatonNodeFactory::execute);
    }
    ...
    public static void execute(final DefaultModel.ExecuteInput input, final DefaultModel.ExecuteOutput output) {
        try {
            ...
            throw new RuntimeException("Ebi command failed: Ebi convert stochastic-nondeterministic-finite-automaton", ex);
        }
    }
}
