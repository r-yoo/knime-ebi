...
public class EbiDiscoverNonStochasticPrefixTreeDeterministicFiniteAutomatonNodeFactory extends EbiDefaultNodeFactory {
	...
	public EbiDiscoverNonStochasticPrefixTreeDeterministicFiniteAutomatonNodeFactory() {
		super(COMMAND_METADATA, EbiDiscoverNonStochasticPrefixTreeDeterministicFiniteAutomatonNodeFactory::addPorts, EbiDiscoverNonStochasticPrefixTreeDeterministicFiniteAutomatonNodeFactory::configureModel);
	}
  ...
  int inputPortIndex = 1;
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiDiscoverNonStochasticPrefixTreeDeterministicFiniteAutomatonNodeFactory::configure)
            .execute(EbiDiscoverNonStochasticPrefixTreeDeterministicFiniteAutomatonNodeFactory::execute);
    }
