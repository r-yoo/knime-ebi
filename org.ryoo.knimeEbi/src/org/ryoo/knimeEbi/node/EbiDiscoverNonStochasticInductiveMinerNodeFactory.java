...
public class EbiDiscoverNonStochasticInductiveMinerNodeFactory extends EbiDefaultNodeFactory {
	private static final EbiCommandMetadata COMMAND_METADATA =
		new EbiCommandMetadata(
			"Ebi discover-non-stochastic inductive-miner",
	...
	public EbiDiscoverNonStochasticInductiveMinerNodeFactory() {
		super(COMMAND_METADATA, EbiDiscoverNonStochasticInductiveMinerNodeFactory::addPorts, EbiDiscoverNonStochasticInductiveMinerNodeFactory::configureModel);
	}
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiDiscoverNonStochasticInductiveMinerNodeFactory::configure)
            .execute(EbiDiscoverNonStochasticInductiveMinerNodeFactory::execute);
    }
    ...
    public static void execute(final DefaultModel.ExecuteInput input, final DefaultModel.ExecuteOutput output) {
        try {
            ...
            throw new RuntimeException(
                "Ebi command failed: Ebi discover-non-stochastic inductive-miner"
