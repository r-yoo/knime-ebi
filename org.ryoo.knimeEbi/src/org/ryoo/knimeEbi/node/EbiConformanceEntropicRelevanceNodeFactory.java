...
public class EbiConformanceEntropicRelevanceNodeFactory extends EbiDefaultNodeFactory {
	...
	public EbiConformanceEntropicRelevanceNodeFactory() {
		super(COMMAND_METADATA, EbiConformanceEntropicRelevanceNodeFactory::addPorts, EbiConformanceEntropicRelevanceNodeFactory::configureModel);
	}
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiConformanceEntropicRelevanceNodeFactory::configure)
            .execute(EbiConformanceEntropicRelevanceNodeFactory::execute);
    }
    ...
    public static void execute(final DefaultModel.ExecuteInput input, final DefaultModel.ExecuteOutput output) {
        try {
            ...
            throw new RuntimeException("Ebi command failed: Ebi conformance entropic-relevance", ex);
        }
    }
}
