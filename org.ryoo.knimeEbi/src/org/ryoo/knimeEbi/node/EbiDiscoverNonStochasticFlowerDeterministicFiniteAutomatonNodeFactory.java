...
public class EbiDiscoverNonStochasticFlowerDeterministicFiniteAutomatonNodeFactory extends EbiDefaultNodeFactory {
	...
	public EbiDiscoverNonStochasticFlowerDeterministicFiniteAutomatonNodeFactory() {
		super(COMMAND_METADATA, EbiDiscoverNonStochasticFlowerDeterministicFiniteAutomatonNodeFactory::addPorts, EbiDiscoverNonStochasticFlowerDeterministicFiniteAutomatonNodeFactory::configureModel);
	}
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiDiscoverNonStochasticFlowerDeterministicFiniteAutomatonNodeFactory::configure)
            .execute(EbiDiscoverNonStochasticFlowerDeterministicFiniteAutomatonNodeFactory::execute);
    }
    ...
    public static void execute(final DefaultModel.ExecuteInput input, final DefaultModel.ExecuteOutput output) {
        try {
            ...
            throw new RuntimeException(
                "Ebi command failed: Ebi discover-non-stochastic flower deterministic-finite-automaton"
