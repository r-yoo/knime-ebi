...
public class EbiFilterTracesEmptyNodeFactory extends EbiDefaultNodeFactory {
	...
	public EbiFilterTracesEmptyNodeFactory() {
		super(COMMAND_METADATA, EbiFilterTracesEmptyNodeFactory::addPorts, EbiFilterTracesEmptyNodeFactory::configureModel);
	}
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiFilterTracesEmptyNodeFactory::configure)
            .execute(EbiFilterTracesEmptyNodeFactory::execute);
    }
