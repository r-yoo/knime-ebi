...
public class EbiConformanceEarthMoversNodeFactory extends EbiDefaultNodeFactory {
	private static final EbiCommandMetadata COMMAND_METADATA =
		new EbiCommandMetadata(
			"Ebi conformance earth-movers",
			"Compute Earth mover's stochastic conformance.",
	...
	public EbiConformanceEarthMoversNodeFactory() {
		super(COMMAND_METADATA, EbiConformanceEarthMoversNodeFactory::addPorts, EbiConformanceEarthMoversNodeFactory::configureModel);
	}
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiConformanceEarthMoversNodeFactory::configure)
            .execute(EbiConformanceEarthMoversNodeFactory::execute);
    }
