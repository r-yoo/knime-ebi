...
public class EbiDiscoverDirectlyFollowsGraphNodeFactory extends EbiDefaultNodeFactory {
	...
	public EbiDiscoverDirectlyFollowsGraphNodeFactory() {
		super(COMMAND_METADATA, EbiDiscoverDirectlyFollowsGraphNodeFactory::addPorts, EbiDiscoverDirectlyFollowsGraphNodeFactory::configureModel);
	}
  ...
  int inputPortIndex = 1;
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .parametersClass(EbiDiscoverDirectlyFollowsGraphNodeSettings.class)
            .configure(EbiDiscoverDirectlyFollowsGraphNodeFactory::configure)
            .execute(EbiDiscoverDirectlyFollowsGraphNodeFactory::execute);
    }
