...
public class EbiDiscoverUniformStochasticProcessTreeNodeFactory extends EbiDefaultNodeFactory {
	...
	public EbiDiscoverUniformStochasticProcessTreeNodeFactory() {
		super(COMMAND_METADATA, EbiDiscoverUniformStochasticProcessTreeNodeFactory::addPorts, EbiDiscoverUniformStochasticProcessTreeNodeFactory::configureModel);
	}
  ...
  int inputPortIndex = 1;
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiDiscoverUniformStochasticProcessTreeNodeFactory::configure)
            .execute(EbiDiscoverUniformStochasticProcessTreeNodeFactory::execute);
    }
