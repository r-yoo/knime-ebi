...
public static void configure(final DefaultModel.ConfigureInput input, final DefaultModel.ConfigureOutput output) 
        ...
        output.setOutSpec(0, TableUtil.createOutputSpec("Ebi discover-non-stochastic flower deterministic-finite-automaton", "Ebi discover-non-stochastic flower deterministic-finite-automaton", StringCell.TYPE));
    }
