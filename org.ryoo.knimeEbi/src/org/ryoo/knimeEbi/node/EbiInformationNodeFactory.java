...
public class EbiInformationNodeFactory extends EbiDefaultNodeFactory {
	...
	public EbiInformationNodeFactory() {
		super(COMMAND_METADATA, EbiInformationNodeFactory::addPorts, EbiInformationNodeFactory::configureModel);
	}
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiInformationNodeFactory::configure)
            .execute(EbiInformationNodeFactory::execute);
    }
    ...
    public static void configure(final DefaultModel.ConfigureInput input, final DefaultModel.ConfigureOutput output) 
        ...
        output.setOutSpec(0, TableUtil.createOutputSpec("Ebi information", "string", StringCell.TYPE));
    }
    ...
    public static void execute(final DefaultModel.ExecuteInput input, final DefaultModel.ExecuteOutput output) {
        try {
            ...
            throw new RuntimeException(
                "Ebi command failed: Ebi information"
