...
public class EbiDiscoverOccurrenceStochasticLabelledPetriNetNodeFactory extends EbiDefaultNodeFactory {
	...
	public EbiDiscoverOccurrenceStochasticLabelledPetriNetNodeFactory() {
		super(COMMAND_METADATA, EbiDiscoverOccurrenceStochasticLabelledPetriNetNodeFactory::addPorts, EbiDiscoverOccurrenceStochasticLabelledPetriNetNodeFactory::configureModel);
	}
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiDiscoverOccurrenceStochasticLabelledPetriNetNodeFactory::configure)
            .execute(EbiDiscoverOccurrenceStochasticLabelledPetriNetNodeFactory::execute);
    }
    ...
    public static void execute(final DefaultModel.ExecuteInput input, final DefaultModel.ExecuteOutput output) {
        try {
            ...
            throw new RuntimeException(
                "Ebi command failed: Ebi discover occurrence stochastic-labelled-Petri-net"
