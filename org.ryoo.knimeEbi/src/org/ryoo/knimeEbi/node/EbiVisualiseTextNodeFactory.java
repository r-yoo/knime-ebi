...
public class EbiVisualiseTextNodeFactory extends EbiDefaultNodeFactory {
	...
	public EbiVisualiseTextNodeFactory() {
		super(COMMAND_METADATA, EbiVisualiseTextNodeFactory::addPorts, EbiVisualiseTextNodeFactory::configureModel);
	}
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiVisualiseTextNodeFactory::configure)
            .execute(EbiVisualiseTextNodeFactory::execute);
    }
    ...
    public static void configure(final DefaultModel.ConfigureInput input, final DefaultModel.ConfigureOutput output) 
        ...
        output.setOutSpec(0, TableUtil.createOutputSpec("Ebi visualise text", "string", StringCell.TYPE));
    }
    ...
    public static void execute(final DefaultModel.ExecuteInput input, final DefaultModel.ExecuteOutput output) {
        try {
            ...
            throw new RuntimeException(
                "Ebi command failed: Ebi visualise text"
