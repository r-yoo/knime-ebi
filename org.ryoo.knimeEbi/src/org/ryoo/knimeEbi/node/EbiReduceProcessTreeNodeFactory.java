...
public class EbiReduceProcessTreeNodeFactory extends EbiDefaultNodeFactory {
	private static final EbiCommandMetadata COMMAND_METADATA =
		new EbiCommandMetadata(
			"Ebi reduce process-tree",
			"Reduce a process tree language-equivalently.",
			"Reduce a process tree language-equivalently.",
			new ArrayList<>(
				List.of(
	...
	public EbiReduceProcessTreeNodeFactory() {
		super(COMMAND_METADATA, EbiReduceProcessTreeNodeFactory::addPorts, EbiReduceProcessTreeNodeFactory::configureModel);
	}
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiReduceProcessTreeNodeFactory::configure)
            .execute(EbiReduceProcessTreeNodeFactory::execute);
    }
    ...
    public static void execute(final DefaultModel.ExecuteInput input, final DefaultModel.ExecuteOutput output) {
        try {
            ...
            throw new RuntimeException(
                "Ebi command failed: Ebi reduce process-tree"
