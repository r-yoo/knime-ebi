...
public class EbiConvertStochasticDeterministicFiniteAutomatonNodeFactory extends EbiDefaultNodeFactory {
	...
	public EbiConvertStochasticDeterministicFiniteAutomatonNodeFactory() {
		super(COMMAND_METADATA, EbiConvertStochasticDeterministicFiniteAutomatonNodeFactory::addPorts, EbiConvertStochasticDeterministicFiniteAutomatonNodeFactory::configureModel);
	}
  ...
  int inputPortIndex = 1;
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiConvertStochasticDeterministicFiniteAutomatonNodeFactory::configure)
            .execute(EbiConvertStochasticDeterministicFiniteAutomatonNodeFactory::execute);
    }
    ...
    public static void execute(final DefaultModel.ExecuteInput input, final DefaultModel.ExecuteOutput output) {
        try {
            ...
            throw new RuntimeException("Ebi command failed: Ebi convert stochastic-deterministic-finite-automaton", ex);
        }
    }
}
