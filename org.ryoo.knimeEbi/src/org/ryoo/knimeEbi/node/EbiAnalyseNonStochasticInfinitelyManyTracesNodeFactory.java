...
public class EbiAnalyseNonStochasticInfinitelyManyTracesNodeFactory extends EbiDefaultNodeFactory {
    ...
    public static void configure(final DefaultModel.ConfigureInput input, final DefaultModel.ConfigureOutput output) 
        ...
        output.setOutSpec(0, TableUtil.createOutputSpec("Ebi analyse-non-stochastic infinitely-many-traces", "boolean", StringCell.TYPE));
    }
    ...
    public static void execute(final DefaultModel.ExecuteInput input, final DefaultModel.ExecuteOutput output) {
        try {
            ...
            throw new RuntimeException("Ebi command failed: Ebi analyse-non-stochastic infinitely-many-traces", ex);
        }
    }
}
