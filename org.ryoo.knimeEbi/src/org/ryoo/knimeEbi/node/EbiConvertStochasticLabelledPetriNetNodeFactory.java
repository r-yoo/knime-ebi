...
public class EbiConvertStochasticLabelledPetriNetNodeFactory extends EbiDefaultNodeFactory {
	...
	public EbiConvertStochasticLabelledPetriNetNodeFactory() {
		super(COMMAND_METADATA, EbiConvertStochasticLabelledPetriNetNodeFactory::addPorts, EbiConvertStochasticLabelledPetriNetNodeFactory::configureModel);
	}
    ...
    private static DefaultModel configureModel(final RequireModelParameters model) {
        return model
            .withoutParameters()
            .configure(EbiConvertStochasticLabelledPetriNetNodeFactory::configure)
            .execute(EbiConvertStochasticLabelledPetriNetNodeFactory::execute);
    }
    ...
    public static void execute(final DefaultModel.ExecuteInput input, final DefaultModel.ExecuteOutput output) {
        try {
            ...
            throw new RuntimeException("Ebi command failed: Ebi convert stochastic-labelled-petri-net", ex);
        }
    }
}
